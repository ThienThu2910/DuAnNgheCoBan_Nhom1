...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($viDoRaw !== '') {
        ...
        if ($viDo === false || $viDo < -90 || $viDo > 90) {
            $loi[] = 'Vĩ độ phải nằm trong khoảng từ -90 đến 90.';
        }
    }
    ...
    if ($kinhDoRaw !== '') {
        ...
        if ($kinhDo === false || $kinhDo < -180 || $kinhDo > 180) {
            $loi[] = 'Kinh độ phải nằm trong khoảng từ -180 đến 180.';
        }
    }
    ...
    $kiemTraTrung = $pdo->prepare(
        'SELECT id
         FROM co_so_san_xuat
         WHERE (ten_co_so = :ten_co_so OR slug = :slug)
           AND id <> :id
         LIMIT 1'
    );
    ...
    if (empty($loi)) {
        try {
            ...
            $capNhat = $pdo->prepare(
                'UPDATE co_so_san_xuat
                 SET ten_co_so = :ten_co_so,
                     slug = :slug,
                     dia_chi = :dia_chi,
                ...
                >
                    <div class="row g-4">
                        <div class="col-lg-8">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="vi_do" class="form-label">
                                        Vĩ độ
                                    </label>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-text">
                                    Để trống để giữ lại ảnh hiện tại.
                                </div>
                            </div>
