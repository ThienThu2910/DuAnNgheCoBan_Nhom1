...
require_once __DIR__ . '/../../includes/functions.php'; // Dùng Helper
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Bạn có chắc chắn muốn xóa cơ sở <strong id="tenCoSoXoa"></strong> không? Thao tác này không thể hoàn tác.
                </div>
