...
if ($tuKhoa !== '') {
    $where .= ' AND ds.ten_dac_san LIKE :tu_khoa ';
...
/*
 * Tạo đường dẫn phân trang nhưng vẫn giữ tìm kiếm và lọc.
 */
...
<section class="specialty-banner">
    <div class="container">
        ...
        <p class="lead mb-0">
            Khám phá những sản vật mang đậm hương vị vùng đất cực Nam.
        </p>
    </div>
</section>
...
<main class="container py-5">
            ...
            <form method="get" class="row g-3">
                <div class="col-lg-6">
                    ...
                    <input
                        ...
                        name="q"
                        class="form-control"
                        placeholder="Ví dụ: cua Cà Mau, tôm khô..."
    ...
    <?php if (empty($danhSachDacSan)): ?>
        <div class="alert alert-warning text-center py-4">
            Không tìm thấy đặc sản phù hợp với nội dung tìm kiếm.
        </div>
    <?php else: ?>
        <div class="row g-4">
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="card specialty-card h-100 shadow-sm">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <p class="text-muted specialty-description">
                                <?= htmlspecialchars(
                                    $dacSan['mo_ta_ngan']
